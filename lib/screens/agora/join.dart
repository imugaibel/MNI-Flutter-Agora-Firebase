...
import 'package:mni/model/message.dart';
import 'package:mni/screens/HearAnim_screen.dart';
import 'package:mni/screens/Loading.dart';
...
class _JoinPageState extends State<JoinPage> {
                ...
                child: (_infoStrings[index].type=='join')? Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Image.network(
                        _infoStrings[index].image,fit: BoxFit.cover,   width: 32.0,
                        height: 32.0,),
                      Padding(
                        padding: const  EdgeInsets.symmetric(
                          horizontal: 8,
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            Image.network(
              widget.hostImage,fit: BoxFit.cover,   width: 32.0,
              height: 32.0,),
                  ...
                  Container(
                    ...
                    child: Stack(
                      ...
                      children: <Widget>[
                        ...
                        Image.network(
                          widget.hostImage,fit: BoxFit.cover,   width: 70.0,
                          height: 70.0,),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Stack(
                      ...
                      children: <Widget>[
                        ...
                        Image.network(
                          widget.userImage,fit: BoxFit.cover,   width: 70.0,
                          height: 70.0,),
                      ],
                    ),
                  ),
  ...
  void _createClient() async {
    ...
    await _client.login(token, widget.username );
