...
import 'package:mni/model/user.dart';
...
class _CallPageState extends State<CallPage>{
  ...
  void _addAgoraEventHandlers() {
       print(  AgoraRtcEngine.onJoinChannelSuccess);
              ...
              return Padding(
                ...
                child: (_infoStrings[index].type=='join')? Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Image.network(
                        _infoStrings[index].image,fit: BoxFit.cover,   width: 40.0,
                        height: 40.0,),
                      /*CachedNetworkImage(
            ...
            child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Image.network(
                      users.image,fit: BoxFit.cover,   width: 40.0,
                      height: 40.0,),
                    Padding(
